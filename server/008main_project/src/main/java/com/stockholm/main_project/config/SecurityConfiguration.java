    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers(HttpMethod.POST, "/cash").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.PATCH, "/cash/{cashId}").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.GET, "/cash").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.POST, "/stockorders").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.POST, "/api/boards").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.PATCH, "/api/boards/{boardId}").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.DELETE, "/api/boards/{boardId}").hasAnyRole("USER","ROLE_USER")
                        ...
                        .antMatchers(HttpMethod.POST, "/api/boards/{boardId}/comment").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.PATCH, "/api/boards/{boardId}/comment/{commentId}").hasAnyRole("USER","ROLE_USER")
                        .antMatchers(HttpMethod.DELETE, "/api/boards/{boardId}/comment/{commentId}").hasAnyRole("USER","ROLE_USER")
